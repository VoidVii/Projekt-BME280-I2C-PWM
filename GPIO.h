...
/** @name PCTL VALUE 
 *  @brief PCTL value 0x03 selects I2C function for the pin (see datasheet)
 *  @{
 */
#define PCTL_VALUE_I2C 0x03U
/** @} */
...
#define GPIO_AFSEL_OFFSET				0x420U			 /**< Alternate Function Selec register */
#define GPIO_ODR_OFFSET 				0x50CU			 /**< Open Drain register */
#define GPIO_PCTL_OFFSET				0x52CU			 /**< Port Control register */
